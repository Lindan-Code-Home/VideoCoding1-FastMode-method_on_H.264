...
{int i,j;
 ...
 TlowqpLindan[8]=7850;
 TlowqpLindan[9]=9450;
 TlowqpLindan[10]=11400;
 TlowqpLindan[11]=13650;
 TlowqpLindan[12]=16350;
 TlowqpLindan[13]=19600;
 TlowqpLindan[14]=23250;
 TlowqpLindan[15]=27500;
 TlowqpLindan[16]=32500;
TlowqpLindan[17]=38300;

 ThighqpLindan[0]=107500;
ThighqpLindan[1]=116500;
ThighqpLindan[2]=126500;
ThighqpLindan[3]=137000;
ThighqpLindan[4]=148500;
ThighqpLindan[5]=160000;
ThighqpLindan[6]=172000;
ThighqpLindan[7]=185000;
ThighqpLindan[8]=199000;
ThighqpLindan[9]=214000;
ThighqpLindan[10]=229500;
ThighqpLindan[11]=245500;
ThighqpLindan[12]=262000;
ThighqpLindan[13]=279000;
ThighqpLindan[14]=296500;
ThighqpLindan[15]=314500;
ThighqpLindan[16]=333000;
ThighqpLindan[17]=351500;
 NumofFramebyLindan=0;
 for(i=0;i<9;i++)
	  for(j=0;j<11;j++)
		 { LofCurrent[i*11+j]=0;
           LofPrevious[i*11+j]=0;
         }
  init_time();
#if MEMORY_DEBUG
  ...
  free_encoder(p_Enc);
  printf("the intra NO in P frame is %d\n",NumofIntraLindan);
  printf("the frame NO is %d\n",NumofFramebyLindan);
  return 0;
}
